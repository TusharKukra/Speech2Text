...
public class MainActivity extends FlutterActivity implements RecognitionListener {
    ...
    private static final String LOG_TAG = "Speech2Text";
    ...
    public void onReadyForSpeech(Bundle params) {
        Log.d("Speech2Text", "onReadyForSpeech");
        speechChannel.invokeMethod("onSpeechAvailability", true);
    }

    @Override
    public void onBeginningOfSpeech() {
        Log.d("Speech2Text", "onRecognitionStarted");
        transcription = "";
    ...
    public void onRmsChanged(float rmsdB) {
        Log.d("Speech2Text", "onRmsChanged : " + rmsdB);
    }

    @Override
    public void onBufferReceived(byte[] buffer) {
        Log.d("Speech2Text", "onBufferReceived");
    }

    @Override
    public void onEndOfSpeech() {
        Log.d("Speech2Text", "onEndOfSpeech");
        speechChannel.invokeMethod("onRecognitionComplete", transcription);
    }

    @Override
    public void onError(int error) {
        Log.d("Speech2Text", "onError : " + error);
    ...
    public void onPartialResults(Bundle partialResults) {
        Log.d("Speech2Text", "onPartialResults...");
    ...
    public void onEvent(int eventType, Bundle params) {
        Log.d("Speech2Text", "onEvent : " + eventType);
    }
